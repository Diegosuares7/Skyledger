...
export class InvalidMovementMappingException extends StepProcessHandledException {
  constructor(sklCode: string) {
    super(PROCESS_STEPS.GENERATE_EXCEL_REGISTERS, EXCEL_TRANSFORMER_ERROR_MESSAGES.INVALID_SKL_MOVEMENTS_CODE(sklCode));
  }
}
