...
describe('processExcelsResults', () => {
  ...
  it(
    'should return a list of ProcessedExcelFile objects when given a list of SAPExcelFileResult objects with ' +
      'status SUCCESS and a non-null file attribute',
    async () => {
      const excelsResults: SAPExcelFileResult[] = [
        {
          file: {
      ...
      const processedExcelFiles = await processExcelsResults(excelsResults);
